...
def update_upload_status(auth_token, sample_name, identifier):
    ...
    data = {
        ...
        'study_type' : request.form.get('studyType', type=str, default=''),
        'site_code' : request.form.get('siteName', type=str, default=''),
        'time_point' : request.form.get('timePoint', type=str, default='')
    }
