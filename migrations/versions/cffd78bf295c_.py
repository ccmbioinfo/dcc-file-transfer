...
def downgrade():
    ...
    sql_create_files2 = text("CREATE TABLE files2 AS SELECT id,identifier,filename,total_size,file_type,readset,platform,run_type,capture_kit,library,reference,upload_status,upload_start_date,upload_end_date,user_id,access_id FROM files")
    conn.execute(sql_create_files2)
